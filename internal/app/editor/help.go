...
var helpColumns = [2][]helpRow{
	...
	},
	{
		...
		{"Ctrl+0", "Zoom to fit (selection or map)"},
		{"Home", "Reset view"},
		...
		helpHeader("Tools & modes (toolbar)"),
		{"Toolbar", "Brush · Line · Rect · Box · Flood · Pick"},
		{"Toolbar", "Select (marquee) · Measure (ruler)"},
		{"Toolbar", "Ramp · Sculpt · Scatter (Elevation/paint)"},
		{"Toolbar", "Mirror X · Mirror Y (symmetry paint)"},
		helpHeader("Help"),
		{"?", "This reference"},
		{"Esc / click", "Close"},
	},
