...
var classSkillTrees = map[PartyClass][]SkillTreeDef{
	...
	ClassWarrior: {
		linearTree("Battle Sense", "Disable, hinder, intercept, react", []SkillTreeNode{
			...
			actOnce("guard", "Guard", "Cover an ally this round; their incoming hits redirect to you.", SkillGuard),
		...
		linearTree("Ancestral Call", "Utility, light heal, protection, summons", []SkillTreeNode{
			...
			actOnce("ancestral-spirit", "Ancestral Spirit", "Summon a warrior shade to fight beside the party.", SkillAncestralSpirit),
		...
		linearTree("Fury", "Lifesteal, bleed, AoE, self-harm", []SkillTreeNode{
			...
			act("reckless-swing", "Reckless Swing", "A heavy hit that lowers your own Armor for a turn.", SkillRecklessSwing),
	...
	ClassCleric: {
		linearTree("Radiance", "Holy offense, smite, anti-status", []SkillTreeNode{
			...
			act("searing-light", "Searing Light", "A radiant damage-over-time.", SkillSearingLight),
			act("blind", "Blind", "Lower an enemy's accuracy for several turns.", SkillBlind),
			act("consecrate", "Consecrate", "AoE radiant damage across the enemy pack.", SkillConsecrate),
			actOnce("judgment", "Judgment", "Capstone: execute low-HP enemies for massive damage.", SkillJudgment),
		}),
		linearTree("Mercy", "Restoration, regen, cleanse, revive", []SkillTreeNode{
			...
			actOnce("resurrect", "Resurrect", "Capstone: revive a downed party member.", SkillResurrect),
		}),
		linearTree("Conviction", "Buffs, wards, retribution", []SkillTreeNode{
			...
			actOnce("martyrs-bond", "Martyr's Bond", "Redirect an ally's incoming damage to the Cleric.", SkillMartyrsBond),
			actOnce("bulwark-of-faith", "Bulwark of Faith", "Capstone: party-wide Armor and MDef aura.", SkillBulwark),
		}),
	},
	// ── Thief ────────────────────────────────────────────────────────
	ClassThief: {
		linearTree("Shadow Arts", "Stealth, evasion, control", []SkillTreeNode{
			...
			actOnce("vanish", "Vanish", "Become untargetable for one turn and drop aggro.", SkillVanish),
		...
		linearTree("Cutpurse", "Larceny, tempo, passive masteries", []SkillTreeNode{
			...
			act("mug", "Mug", "Deal damage and steal in a single hit.", SkillMug),
	...
	ClassWizard: {
		linearTree("Pyromancy", "Fire, burn, AoE detonation", []SkillTreeNode{
			...
			act("immolate", "Immolate", "A sustained Burn damage zone.", SkillImmolate),
			act("combust", "Combust", "Detonate a target's Burn stacks for a damage spike.", SkillCombust),
			actOnce("meteor", "Meteor", "Capstone: a massive delayed AoE.", SkillMeteor),
		}),
		...
		linearTree("Storm", "Lightning, chain, arcane utility", []SkillTreeNode{
			...
			act("chain-lightning", "Chain Lightning", "Lightning that bounces across the pack.", SkillChainLightning),
			act("static-field", "Static Field", "Deal damage as a share of the enemy's current HP.", SkillStaticField),
			actOnce("dispel", "Dispel", "Strip a buff or status from an enemy.", SkillDispel),
