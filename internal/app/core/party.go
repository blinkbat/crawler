...
var skillDefinitions = []skillDefinition{
	{Skill: SkillSwipe, Name: "Swipe", Description: "STR-scaled cleave through the enemy front row.", Cost: 2, TargetMode: ActionMenu, Kind: SkillKindMelee, Tag: SkillTagPhys, Minigame: MinigamePress, Effect: SkillEffect{Damage: 0, AppliesAOEEnemies: true}, PlayerCastable: true},
	...
	{Skill: SkillImmolate, Name: "Immolate", Description: "INT-scaled fire across the whole pack that sets every enemy ablaze — a long, guaranteed Burn. Charge.", Cost: 8, TargetMode: ActionMenu, Kind: SkillKindMagic, Tag: SkillTagMagic, Minigame: MinigameCharge, Effect: SkillEffect{Damage: ImmolateDamageBase, AppliesAOEEnemies: true, BurnChance: AlwaysApplies, BurnMinTurns: ImmolateBurnMinTurns, BurnMaxTurns: ImmolateBurnMaxTurns}, PlayerCastable: true},
