...
var skillOnDiskPins = map[SkillID]string{
	...
	SkillSearingLight:    "searing_light",
	SkillImmolate:        "immolate",
	SkillMug:             "mug",
	SkillChainLightning:  "chain_lightning",
	SkillStaticField:     "static_field",
	SkillGuard:           "guard",
	SkillConsecrate:      "consecrate",
	SkillJudgment:        "judgment",
	SkillRecklessSwing:   "reckless_swing",
	SkillCombust:         "combust",
	SkillBulwark:         "bulwark_of_faith",
	SkillDispel:          "dispel",
	SkillVanish:          "vanish",
	SkillMartyrsBond:     "martyr's_bond",
	SkillResurrect:       "resurrect",
	SkillMeteor:          "meteor",
	SkillAncestralSpirit: "ancestral_spirit",
}
